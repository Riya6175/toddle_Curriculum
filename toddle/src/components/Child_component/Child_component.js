...
export default function Child_component(props) {
  ...
  return (
    ...
    <div>
      ...
      <div className='Text'>
          {props.props && <input type="text" id="topic" ref={inputRef} className={props.props.level === 0 ? 'Topic' : props.props.level === 1 ? 'topic_child' : 'topic_subchild'} name="Topic" placeholder="Text" size="2500" defaultValue= {props.props.data}></input>}
